 ...
 */
public class IngresoGasto extends javax.swing.JInternalFrame {
...
private void fecha(){
        ...
        try {
            ...
            java.util.Date fechaDate = formato.parse(CajaRegistradora.fechaact());
    ...
    private void btnregistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregistrarActionPerformed
        ...
        String sql="INSERT INTO FlujoCaja (Comentario,Ingreso,Fecha,Hora,TipoOperacion) VALUES (?,?,?,?,?)";
        try {
            PreparedStatement pst  = cn.prepareStatement(sql);
            pst.setString(1, txtDescGasto.getText());
            pst.setString(2, txtgasto.getText());
            pst.setString(3, fecha);
            pst.setString(4, CajaRegistradora.horaact());
