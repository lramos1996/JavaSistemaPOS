 ...
 */
public class IngresoTalla extends javax.swing.JInternalFrame {
    ...
    void cargar(String valor) {
        try{
            ...
            String cons="select * from talla WHERE CONCAT (cod_talla,des_talla,coment) LIKE '%"+valor+"%'";
        ...
        try{
            ...
            String cons="select * from talla WHERE cod_talla='"+cod+"'";
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(cons);
            while(rs.next())
            {
        ...
        String num="";
        String c="";
         String SQL="select max(cod_talla) from talla";
...
// TODO add your handling code here:
    String cod,des,pre;
            ...
            sql="INSERT INTO talla (cod_talla,des_talla,coment) VALUES (?,?,?)";
        try {
            ...
            Logger.getLogger(IngresoTalla.class.getName()).log(Level.SEVERE, null, ex);
        }
}//GEN-LAST:event_btnguardarActionPerformed

private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
// TODO add your handling code here:
     String sql="UPDATE talla SET coment = '"+txtcom.getText()+"',des_talla ='"+txtdes.getText()+"' WHERE cod_talla = '"+txtcod.getText()+"'"; 
    try {
        PreparedStatement pst = cn.prepareStatement(sql);
        pst.executeUpdate();
    ...
    try {
        ...
        {    
            String cod=(String)tbtallas.getValueAt(filaMod, 0);             
            try{                   
                String cons="delete from talla WHERE cod_talla='"+cod+"'";      
